...
export default function Hero() {
    ...
    return (
        <section className="max-w-2xl mx-auto px-4 py-40 sm:py-44 min-h-screen text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-accent-soft rounded-full text-xs text-accent mb-6 border border-accent/15">
                <div className="relative flex items-center justify-center">
                    <div className="absolute bg-teal-500 size-2 rounded-full animate-ping"></div>
                    <div className="bg-teal-500 size-1.5 rounded-full"></div>
                </div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-medium leading-tight mb-6 text-foreground">
                Analyze & Boost Your <span className="gradient-text playfair">SEO Rankings</span>
            </h1>
            ...
            <form onSubmit={handleQuickAnalyze} className="max-w-2xl mx-auto relative">
                <div className="bg-card rounded-full px-2 py-1.5 flex items-center gap-2 input-glow">
                    ...
                    <button type="submit" className="cta-gradient px-5 py-2.5 rounded-full text-sm shrink-0 flex items-center gap-2" id="hero-analyze-btn">
                        Analyze
